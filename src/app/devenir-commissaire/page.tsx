          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 text-lg leading-relaxed text-zinc-600">
                ...
                et accessible à toutes et tous — licence <strong className="text-zinc-900">FFSA</strong> pour les disciplines auto,
                licence <strong className="text-zinc-900">FFM</strong> pour les disciplines moto.
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {roles.map((role) => (
                <div key={role.title} className="rounded-[28px] border border-zinc-200 bg-white shadow-sm p-6">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-zinc-600">{role.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="border-t border-zinc-200 bg-white py-20 lg:py-32">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <p className="mt-5 mx-auto max-w-2xl text-zinc-600 text-lg">
          ...
          <div className="mb-4 flex items-center gap-4">
            <span className="text-xs font-black uppercase tracking-[0.3em] text-zinc-600">Auto — FFSA</span>
            ...
            {licenses.map((lic) => (
              <div key={lic.grade} className={`rounded-[32px] border p-8 ${lic.color}`}>
                ...
                <div className="mt-4 flex items-baseline gap-3">
                  ...
                  <h3 className="text-xl font-black text-zinc-900">{lic.subtitle}</h3>
                </div>
                <p className="mt-4 text-zinc-600 leading-relaxed">{lic.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mb-4 mt-14 flex items-center gap-4">
            <span className="text-xs font-black uppercase tracking-[0.3em] text-zinc-600">Moto — FFM</span>
            <div className="flex-1 border-t border-zinc-200" />
          </div>
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-[32px] border border-zinc-200 bg-white shadow-sm p-8">
              <span className="text-xs font-black uppercase tracking-[0.2em] text-zinc-700">FFM</span>
              <div className="mt-4 flex items-baseline gap-3">
                <span className="text-5xl font-black text-zinc-700">OFS</span>
                <h3 className="text-xl font-black text-zinc-900">Officiel Stagiaire</h3>
              </div>
            ...
            <div className="rounded-[32px] border border-[#FF5A1F]/30 bg-[#FF5A1F]/5 p-8">
              ...
              <div className="mt-4 flex items-baseline gap-3">
                ...
                <h3 className="text-xl font-black text-zinc-900">Officiel</h3>
              </div>
              <p className="mt-4 text-zinc-600 leading-relaxed">
          ...
          <div className="mt-6 rounded-[24px] border border-zinc-200 bg-zinc-50 p-5 text-center">
            <p className="text-sm text-zinc-700">
      ...
      <section className="border-t border-zinc-200 bg-zinc-50 py-20 lg:py-32">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            ...
            <div className="mt-6 inline-flex items-center gap-3 rounded-full border border-zinc-300 bg-white px-5 py-2 text-sm text-zinc-600">
          ...
          <div className="space-y-4">
            {steps.map((step, i) => (
              <div key={step.num} className="flex gap-6 rounded-[28px] border border-zinc-200 bg-white shadow-sm p-6 lg:p-8">
                <div className="shrink-0">
                  <span className="text-5xl font-black text-zinc-200">{step.num}</span>
                </div>
                <div>
                  <h3 className="text-xl font-black lg:text-2xl">{step.title}</h3>
                  <p className="mt-3 text-zinc-600 leading-relaxed">{step.desc}</p>
      ...
      <section className="border-t border-zinc-200 bg-white py-20 lg:py-32">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-8 space-y-4">
                {[
                  ...
                  <div key={text} className="flex items-start gap-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
            ...
            <div className="rounded-[40px] border border-zinc-200 bg-zinc-50 shadow-sm p-8 lg:p-12">
              ...
              <div className="mt-8 space-y-4">
                ...
                <Link
                  href="/events"
                  className="flex h-14 w-full items-center justify-center rounded-2xl border border-zinc-300 bg-white text-zinc-700 font-black transition hover:border-[#FF5A1F]/40"
                >
      ...
      <section className="border-t border-zinc-200 bg-zinc-50 py-20 lg:py-32">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-3xl space-y-4">
            {faqs.map((faq) => (
              <div key={faq.q} className="rounded-[24px] border border-zinc-200 bg-white shadow-sm p-6 lg:p-8">
                <h3 className="text-lg font-black">{faq.q}</h3>
                <p className="mt-3 text-zinc-600 leading-relaxed">{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
