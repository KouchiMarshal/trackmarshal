  ...
  return (
    <main className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-24 pt-40 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 text-4xl font-black lg:text-6xl text-zinc-900">Politique de confidentialité</h1>
        ...
        <div className="mt-12 space-y-10 text-zinc-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">1. Qui sommes-nous ?</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">2. Données collectées</h2>
            ...
            <ul className="mt-4 space-y-2 text-zinc-500">
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><span><strong className="text-zinc-900">Données d'identification :</strong> nom complet, adresse email</span></li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><span><strong className="text-zinc-900">Données de profil :</strong> photo de profil, ville, pays, biographie, années d'expérience, disciplines pratiquées</span></li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><span><strong className="text-zinc-900">Données de licence :</strong> type de licence, numéro de licence, copie du document de licence</span></li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><span><strong className="text-zinc-900">Données d'activité :</strong> candidatures soumises, messages échangés, événements publiés</span></li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><span><strong className="text-zinc-900">Données techniques :</strong> cookies de session (authentification uniquement)</span></li>
            </ul>
          </div>

          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">3. Finalités du traitement</h2>
            ...
            <p className="mt-4">
              Base légale : <strong className="text-zinc-900">exécution du contrat</strong> (article 6.1.b RGPD) pour les données nécessaires au service,
              et <strong className="text-zinc-900">intérêt légitime</strong> (article 6.1.f RGPD) pour la sécurité de la plateforme.
            </p>
          </div>

          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">4. Durée de conservation</h2>
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">5. Sous-traitants</h2>
            ...
            <div className="mt-4 space-y-4">
              {[
                ...
                <div key={p.name} className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-1 text-sm text-zinc-500">{p.role} — {p.country}</p>
                </div>
              ))}
            </div>
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">6. Vos droits</h2>
            <p>Conformément au RGPD, vous disposez des droits suivants sur vos données :</p>
            <ul className="mt-4 space-y-2 text-zinc-500">
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><strong className="text-zinc-900">Accès</strong> — consulter les données que nous détenons sur vous</li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><strong className="text-zinc-900">Rectification</strong> — corriger des données inexactes</li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><strong className="text-zinc-900">Suppression</strong> — demander l'effacement de vos données</li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><strong className="text-zinc-900">Portabilité</strong> — recevoir vos données dans un format structuré</li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><strong className="text-zinc-900">Opposition</strong> — vous opposer à certains traitements</li>
              <li className="flex gap-3"><span className="text-[#FF5A1F] shrink-0">→</span><strong className="text-zinc-900">Limitation</strong> — limiter le traitement dans certains cas</li>
            </ul>
            <p className="mt-4">
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">7. Cookies</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">8. Modifications</h2>
            <p>
