  ...
  return (
    <main className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-24 pt-40 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 text-4xl font-black lg:text-6xl text-zinc-900">Mentions légales</h1>
        ...
        <div className="mt-12 space-y-10 text-zinc-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">1. Éditeur du site</h2>
            <p>Le site <strong>TrackMarshal</strong> (accessible à l'adresse <strong>www.trackmarshal.app</strong>) est édité par :</p>
            <ul className="mt-3 space-y-1 text-zinc-500">
              <li><strong className="text-zinc-900">Nom :</strong> Kevin Foussard</li>
              <li><strong className="text-zinc-900">Statut :</strong> Particulier</li>
              <li><strong className="text-zinc-900">Ville :</strong> Alençon, France</li>
              <li><strong className="text-zinc-900">Email :</strong>{" "}
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">2. Directeur de la publication</h2>
            <p>Kevin Foussard</p>
          </div>

          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">3. Hébergement</h2>
            <p>Le site est hébergé par :</p>
            <ul className="mt-3 space-y-1 text-zinc-500">
              <li><strong className="text-zinc-900">Société :</strong> Vercel Inc.</li>
              <li><strong className="text-zinc-900">Adresse :</strong> 340 Pine Street Suite 701, San Francisco, CA 94104, États-Unis</li>
              <li><strong className="text-zinc-900">Site web :</strong>{" "}
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">4. Propriété intellectuelle</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">5. Données personnelles</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">6. Cookies</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-black text-zinc-900 mb-4">7. Contact</h2>
            <p>
