          ...
          <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white">
            <div className="mx-auto flex h-20 max-w-[1600px] items-center justify-between px-4 sm:px-6 lg:px-10">
              <div>
                ...
                <h1 className="mt-2 text-2xl font-black text-zinc-900 lg:text-4xl">Mes favoris</h1>
              </div>
              <NotificationBell />
            </div>
          </header>
          ...
          <div className="mx-auto max-w-[1600px] p-4 pb-24 sm:p-6 lg:p-10 lg:pb-10">
            ...
            {!loading && favorites.length === 0 && (
              <div className="rounded-[32px] border border-zinc-200 bg-white p-12 text-center shadow-sm">
                <Heart size={48} className="mx-auto mb-6 text-zinc-300" />
                <h2 className="text-3xl font-black text-zinc-900">Aucun favori</h2>
                <p className="mt-4 text-zinc-500">
                  Ajoutez des événements à vos favoris depuis la liste des événements.
                </p>
                <Link
                  href="/events"
                  className="mt-8 inline-flex h-14 items-center rounded-2xl bg-[#FF5A1F] px-8 font-black text-white transition hover:scale-[1.01]"
                >
                  Voir les événements
                </Link>
              </div>
                ...
                >
                  <div className="relative h-[220px]">
                    ...
                    <button
                      ...
                      className="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full bg-white/80 transition hover:scale-110"
                    >
                      <Heart size={18} className={isFavorite(event.slug) ? "fill-[#FF5A1F] text-[#FF5A1F]" : "text-zinc-600"} />
                    </button>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      ...
                      className="mt-6 flex h-12 items-center justify-center rounded-2xl bg-[#FF5A1F] font-bold text-white transition hover:scale-[1.01]"
                    >
                      Voir l'événement
                    </Link>
                  </div>
