...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 text-zinc-900 px-4">
      <div className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#FF5A1F]/6 blur-[160px] pointer-events-none" />
      ...
      <div className="relative z-10 text-center">
        ...
        <h1 className="mt-4 text-8xl font-black lg:text-[12rem] leading-none text-zinc-900">404</h1>
